...
## 2026-08-22 (금요일) — "자본의 심리학: 60/40 의 붕괴와 헤지펀드의 시대"

### 오늘의 브리핑

#### [MONEY-FLOW] 자본의 심리학: 60/40 의 붕괴와 헤지펀드의 시대 (09:30)

- **파일**: `outputs/briefings/BRIEFING_MONEY-FLOW_2026-08-22.md`
- **핵심 시그널**:
  1. **헤지펀드 기록적 유입** — AUM $5.22 조 (14 분기 연속 최고), Q1 순유입 $445 억 (2007 년 이후 최고), 87.6% 대형사 집중
  2. **연금기금 주식 초과배분 위험** — 채권 대비 주식 27% 초과 (15 년 최고), 향후 12 개월 주식 언더퍼폼 3.2% 예상
  3. **Fed 인플레이션 고착화** — 기준금리 3.50-3.75% 동결, 핵심 PCE 3.4%, 원유 $84 (연초 $57 → $113 → $84)
  4. **원/달러 구조적 약세** — ₩1,414/USD, 2026 전망 1,450 원, 서비스 수지 적자 $200 억+, 한미 금리차 1.5%p
- **Human Gates**: 4 개 선언 (자본 배분 심의회, 연금 리스크 모니터링 24h, 예산 유연성 심의회, 환율 임계치 감시)
- **정체성 전환**: 감시자 → 정원사 (자본이 60/40 을 버린 것처럼, HR 도 '정규직 60%' 신화를 버려라)
...
- **2026-08-14 09:10** — [I/O 심리학 브리핑](2026-08-14-io-psych.md) 생성:
  ...
  - **Human Gate 4 개:** 의사결정 아키텍처 심의회, 에이전트 조직 설계 심의회, 알고리즘 공정성 감사 위원회, AI 신뢰 수준 공개 의무
  - **정체성 전환:** "감시자 (Guardian) → 정원사 (Gardener)" — Kant 의 계몽 프레임: "AI 의 한계를 직시하고 인간이 검증하는 구조 설계"
