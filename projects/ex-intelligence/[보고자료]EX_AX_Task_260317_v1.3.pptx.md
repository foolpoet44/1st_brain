...
status: Active
type: Project
original_path: "S:\★Y26\2월\Pulse_pjt\[보고자료]EX_AX_Task_260317_v1.3.pptx"
...
작동원리
Health Check Process (안)
Communication & Solution 제공
구성원 참여 촉진 방안
시스템 구체화 및 구현 방안
PRI HR 실 / EXG팀｜ 2026. 03. 16.
...
2. EX Intelligence : AX 기반 일하는 방식의 전환

EX Intelligence는 구성원의 인식·행동을 데이터로 읽고, AI로 분석하며, 즉각적인 솔루션으로 연결하는 AX 기반 상시 진단 체계입니다.
...
→ 통찰 심화
→ 정밀도 향상
AX 기반의 일하는 방식 전환은 단순한 도구적 효율화 넘어,
판단하고 움직이는 방식을 바꿉니다.
...
3. 작동원리 : “Signal”에서 “Action”까지

구성원의 환경인식과 심리상태 실시간으로 수집하고 AI 이상징후 분석을 통해 계층별 실행 인사이트를 제공함.
...
6. 구성원 참여 촉진 방안 : 지속 참여를 통한 선순환 구조 구축
...
획득
재방문
초기버전: 키워드 뉴스 메일크롤링PGM
스트레스 프로그램 연계

![](그림190.jpg)

특정 팀 '스트레스' 키워드 40% 이상 → 번아웃 위험 신호 감지 , 건강 프로그램 / WLB , 운동시설 , 상담실 연계
...
![텍스트, 전자제품, 스크린샷, 휴대 전화이(가) 표시된 사진 자동 생성된 설명](그림230.jpg)
이벤트게임
개인 포인트
교환소
...
유첨. 조직 신호에서 행동까지 : AX가 완성하는 Real-Time HR 솔루션

감(感)이 아닌 데이터로, 보고가 아닌 행동으로 — AI가 조직 신호를 실시간 행동으로 전환
...
■ AI 자동 분석 및 행동제안 프로세스 (Intervention Flow)
